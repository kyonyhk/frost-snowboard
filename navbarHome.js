document.addEventListener('DOMContentLoaded', function() {
  ...
  menuText.addEventListener('mouseenter', function() {
    ...
    console.log('Applying stroke gradient #paint1_linear_3240_2372');
    gsap.to(navbarBackgroundPath, { attr: { stroke: 'url(#paint1_linear_3240_2372)' }, duration: 0.5, ease: 'power4.inOut' });
  });
  ...
  menuText.addEventListener('mouseleave', function() {
    ...
    console.log('Reverting stroke gradient to #paint0_linear_3227_209');
    gsap.to(navbarBackgroundPath, { attr: { stroke: 'url(#paint0_linear_3227_209)' }, duration: 0.3, ease: 'power4.inOut' });
  });
  ...
  backButton.addEventListener('mouseenter', function() {
    ...
    console.log('Applying stroke gradient #paint1_linear_3240_2418');
    gsap.to(navbarBackgroundPath, { attr: { stroke: 'url(#paint1_linear_3240_2418)' }, duration: 0.5, ease: 'power4.inOut' });
  });
